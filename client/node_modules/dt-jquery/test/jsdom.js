    ...
    add: {
      ...
      simple: function(æ) {
        ...
        setTimeout(function() {
          ...
          æ.equal("42" + (tpl === ((_ref = t.xml) != null ? (_ref1 = _ref.parent) != null ? (_ref2 = _ref1.builder) != null ? _ref2.template : void 0 : void 0 : void 0)), "42true");
        ...
        setTimeout(function() {
          ...
          æ.equal("23" + (tpl === ((_ref = t.xml) != null ? (_ref1 = _ref.parent) != null ? (_ref2 = _ref1.builder) != null ? _ref2.template : void 0 : void 0 : void 0)), "23true");
          return t.ready(function() {
      ...
      'after end': function(æ) {
        ...
        next_step = function() {
          return setTimeout(function() {
            ...
            æ.equal("16" + (tpl === ((_ref = t.xml) != null ? (_ref1 = _ref.parent) != null ? (_ref2 = _ref1.builder) != null ? _ref2.template : void 0 : void 0 : void 0)), "16true");
            return t.ready(function() {
              return æ.equal(_this.html(t.jquery), ["<span></span>"].join(""));
            });
          }, 16);
      ...
      'template into template': function(æ) {
        ...
        setTimeout(function() {
          ...
          æ.equal("9" + (tpl === ((_ref = t.xml) != null ? (_ref1 = _ref.parent) != null ? (_ref2 = _ref1.builder) != null ? _ref2.template : void 0 : void 0 : void 0)), "9true");
          return t.ready(function() {
            return æ.equal(_this.html(t.jquery), ["<span></span>"].join(""));
          });
        }, 9);
      ...
      'to second level': function(æ) {
        ...
        setTimeout(function() {
          ...
          æ.equal("8" + (tpl === ((_ref1 = t.xml) != null ? (_ref2 = _ref1.parent) != null ? (_ref3 = _ref2.builder) != null ? _ref3.template : void 0 : void 0 : void 0)), "8true");
          return t.ready(function() {
            return æ.equal(_this.html(t.jquery), ["<footer></footer>"].join(""));
          });
        }, 8);
        setTimeout(function() {
          ...
          æ.equal("13" + (footer === ((_ref1 = t.xml) != null ? (_ref2 = _ref1.parent) != null ? (_ref3 = _ref2.builder) != null ? _ref3.template : void 0 : void 0 : void 0)), "13true");
          return t.ready(function() {
    ...
    replace: {
      ...
      instant: function(æ) {
        ...
        setTimeout(function() {
          ...
          æ.equal("3" + (tpl === ((_ref = t.xml) != null ? (_ref1 = _ref.parent) != null ? (_ref2 = _ref1.builder) != null ? _ref2.template : void 0 : void 0 : void 0)), "3true");
          return t.ready(function() {
      ...
      'after end': function(æ) {
        ...
        next_step = function() {
          ...
          return setTimeout(function() {
            ...
            æ.equal("7" + (tpl === ((_ref1 = t.xml) != null ? (_ref2 = _ref1.parent) != null ? (_ref3 = _ref2.builder) != null ? _ref3.template : void 0 : void 0 : void 0)), "7true");
            return t.ready(function() {
              æ.equal("jqueryified:" + ((t.jquery != null) && 'yes' || 'no'), "jqueryified:yes");
              return æ.equal(_this.html(t.jquery), ["<p></p>"].join(""));
            });
